...
--
-- Máquina: localhost
-- Data de Criação: 06-Nov-2019 às 01:26
...
CREATE TABLE IF NOT EXISTS `tb_agendamento` (
  `cd_agendamento` int(11) AUTO_INCREMENT,
...
INSERT INTO `tb_agendamento` (`cd_agendamento`, `dt_agendamento`, `hr_agendamento`, `cd_cliente`, `cd_profissional`) VALUES
(1, '2018-10-22', '14:20:20', 1, 1),
(2, '2018-09-15', '15:52:20', 2, 1);
...
CREATE TABLE IF NOT EXISTS `tb_cliente` (
  `cd_cliente` int(11) AUTO_INCREMENT,
  `nm_cliente` varchar(256) DEFAULT NULL,
  `cd_tel_fixo_cliente` int(10) DEFAULT NULL,
  `cd_tel_cell_cliente` int(11) DEFAULT NULL,
  `nm_email_cliente` varchar(256) DEFAULT NULL,
  `cd_cpf_cliente` int(11) DEFAULT NULL,
...
(2, 'Camila Prieto Martins', 1334638303, 2147483647, 'camila@gmail.com', 2147483647, '2002/09/15', '123', NULL, 1);
...
CREATE TABLE IF NOT EXISTS `tb_profissional` (
  `cd_profissional` int(11) AUTO_INCREMENT,
  `nm_profisisonal` varchar(256) DEFAULT NULL,
  `cd_tel_fixo_profissional` int(10) DEFAULT NULL,
  `cd_tel_cell_profissional` int(11) DEFAULT NULL,
  `nm_email_profissional` varchar(256) DEFAULT NULL,
  `cd_cpf_profissional` int(11) DEFAULT NULL,
...
(1, 'Manicure', 'cuidar das mãos'),
(2, 'Pedicure', 'cuidar dos pés');
...
CREATE TABLE IF NOT EXISTS `tb_servico_agendamento` (
  `cd_servico_agendamento` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_servico_profissional` (
  `cd_servico_profissional` int(11) NOT NULL,
  `cd_profissional` int(11) DEFAULT NULL,
  `cd_servico` int(11) DEFAULT NULL,
...
--
-- Extraindo dados da tabela `tb_servico_profissional`
--

INSERT INTO `tb_servico_profissional` (`cd_servico_profissional`, `cd_profissional`, `cd_servico`) VALUES
(1, 1, 1),
(2, 1, 2);
